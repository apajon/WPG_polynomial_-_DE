function [displ,angleact,Fc_mc3,PcSurf,ind_Cont,ind_Cont3,Ftot,Z,Kcart,no_conv] = PsoleAngle(m,Ccc,sole,P0,Pg,fric,contAngle,FcSurf,displ,angleact,Fdes,Zdes)
D = 3;
no_conv = [];
if contAngle==1
...
% else
    ...
    [displ,angleact,FtotZMP,Fc_mc3_out,PcSurf,ind_cont_out,Kcart] = GaussFtotZMP(contAngle,fric,m,displ,angleact,FtotZMPdes,FcNew3,Pfree,PabsOld,Ccc);
