function [Acons Bcons] = zmp_constraint_stability_DSP_xy_1(xApzmp,xBpzmp,yApzmp,yBpzmp,pankinit1,pankinit2,pankfin1,discretization,backtoankle,fronttoankle,exttoankle,inttoankle,sole_margin,theta,type_phase,nbparamBb)
