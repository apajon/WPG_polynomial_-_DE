...
function [A B] = torque_ankle_DSP_gradient_analytic(Apzmp1,Bpzmp1,Afcom,Bfcom,Apankle,Bpankle,mg,ha,Afb)

A1=ha*Afb*([-Afcom zeros(size(Afcom,1),size(Apankle,2))]);
A2=+Afb*mg*Apzmp1;
A3=[zeros(size(Afcom)) -Afb*mg*Apankle];
A=A1+A2+A3;
